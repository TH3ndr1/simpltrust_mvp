-- Drop both versions of the update_organization function to resolve ambiguity
DROP FUNCTION IF EXISTS public.update_organization(UUID, TEXT, TEXT, TEXT, TEXT, TEXT, UUID);
DROP FUNCTION IF EXISTS public.update_organization(UUID, TEXT, UUID, TEXT, TEXT, TEXT, TEXT);

-- Recreate the update_organization function with a consistent parameter ordering
