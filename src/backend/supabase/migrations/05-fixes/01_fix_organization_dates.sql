-- Fix for organization dates issue where timestamps were showing as 1970-01-01

-- Update existing organization timestamps if they're null or at epoch
...
-- Update the create_organization_with_admin function to set timestamps explicitly
...
-- Update the get_user_organizations function to return timestamps
